...
namespace Niubi\ConfigurableProduct\Block\Rewrite\Catalog\Product\View\Options\Type;
    ...
    public function afterGetValuesHtml(\Magento\Catalog\Block\Product\View\Options\Type\Select $subject, $result)
    {
        ...
        if ($_option->getType() == \Magento\Catalog\Model\Product\Option::OPTION_TYPE_RADIO ||
            ...
            foreach ($_option->getValues() as $_value) {
                ...
                if (strpos($_value->getData('stock'),'no_stock')!==false){
                    $trueClass=   ' option_optionStock';
                }else{
                    $trueClass=  '';
                }
                ...
                $selectHtml .= '<div class="field choice admin__field admin__field-option'.$trueClass .
                    $require .
                    '">' .
                    '<input type="' .
                    $type .
